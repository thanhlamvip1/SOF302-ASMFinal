                    ...
                    <div class="contacts">
                        <section class="contacts__item">
                            ...
                            <div class="contacts__right">
                                <a class="contacts__number">0829559037</a><br>
                                <a class="contacts__link">caodangfpt.dn@fpt.edu.vn</a>
                            </div>
                        </section>
                        <section class="contacts__item">
                            <div class="contacts__left">
                            ...
                            <div class="contacts__right">
                                <span class="contacts__text">Innovation Building, lot 137 , Nguyen Thi Thap ,<br> Da Nang</span>
                            </div>
                        </section>
                        <section class="contacts__item">
                            <div class="contacts__left">
